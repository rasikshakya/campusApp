...
const styles = StyleSheet.create({
  ...
  card:        { backgroundColor: '#fff', borderRadius: 14, padding: 28, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 },
  logoCircle:  { width: 56, height: 56, borderRadius: 28, backgroundColor: '#1A5276', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', marginBottom: 14 },
  logoText:    { color: '#fff', fontSize: 18, fontWeight: '700' },
  title:       { fontSize: 20, fontWeight: '600', color: '#1A3D5C', textAlign: 'center', marginBottom: 4 },
  subtitle:    { fontSize: 13, color: '#888', textAlign: 'center', marginBottom: 22 },
  field:       { marginBottom: 14 },
  label:       { fontSize: 11, fontWeight: '600', color: '#555', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 5 },
  input:       { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, padding: 10, fontSize: 14, color: '#333', backgroundColor: '#fafafa' },
  errorBox:    { backgroundColor: '#FDEDEC', borderWidth: 1, borderColor: '#E74C3C', borderRadius: 8, padding: 10, marginBottom: 12 },
  ...
  footer:      { flexDirection: 'row', justifyContent: 'center', marginTop: 18, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#eee' },
